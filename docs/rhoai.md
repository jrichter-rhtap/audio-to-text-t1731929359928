...
3) Access the `workbench` named `audio-to-text-t1731929359928-notebook`.
...
5) In the terminal, run `cd audio-to-text-t1731929359928` to navigate to your sample app's directory.
